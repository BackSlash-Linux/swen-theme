...
install() {
  ...
  local LOOKFEEL_THEME="${LOOKFEEL_DIR}/com.backslashlinux.${name}"
  ...
  cp -ur ${SRC_DIR}/color-schemes/Swen.colors                                        ${PLASMA_DIR}/${name}/colors
  cp -ur ${SRC_DIR}/plasma/look-and-feel/com.backslashlinux.${name}              ${LOOKFEEL_DIR}
}
